...
ApplicationMain.preloader_onComplete = function(event) {
	...
	} else Reflect.field(cl.async.test.Button,"main").apply(cl.async.test.Button,[]);
}
...
cl.async = {}
cl.async.test = {}
cl.async.test.Button = function() {
	this.buttonDownColor = 65280;
	this.buttonOverColor = 16776960;
	this.buttonColor = 16750848;
	jeash.display.Sprite.call(this);
	this.createButton();
};
$hxClasses["cl.async.test.Button"] = cl.async.test.Button;
cl.async.test.Button.__name__ = ["cl","async","test","Button"];
cl.async.test.Button.__super__ = jeash.display.Sprite;
cl.async.test.Button.prototype = $extend(jeash.display.Sprite.prototype,{
	onMouseOver: function(event) {
		this.setColor(this.buttonOverColor);
	...
	,onMouseMove: function(event) {
		var coords = "(" + this.jeashGetMouseX() + "," + this.jeashGetMouseY() + ")";
		console.log(coords);
	}
	...
	,onMouseDown: function(event) {
		this.setColor(this.buttonDownColor);
	...
	,setColor: function(color) {
		this.jeashGetGraphics().beginFill(color,1);
		this.jeashGetGraphics().drawRoundRect(0,0,100,40,20,20);
	}
	,createButton: function() {
		this.jeashGetGraphics().beginFill(this.buttonColor,1);
		this.jeashGetGraphics().lineStyle(2,16711680,1);
		this.jeashGetGraphics().drawRoundRect(0,0,100,40,20,20);
		this.addEventListener(jeash.events.MouseEvent.CLICK,$bind(this,this.onClick));
		this.addEventListener(jeash.events.MouseEvent.MOUSE_MOVE,$bind(this,this.onMouseMove));
		this.addEventListener(jeash.events.MouseEvent.MOUSE_OUT,$bind(this,this.onMouseOut));
		this.addEventListener(jeash.events.MouseEvent.MOUSE_OVER,$bind(this,this.onMouseOver));
		this.addEventListener(jeash.events.MouseEvent.MOUSE_DOWN,$bind(this,this.onMouseDown));
		this.addEventListener(jeash.events.MouseEvent.MOUSE_UP,$bind(this,this.onMouseUp));
	}
	,__class__: cl.async.test.Button
});
var haxe = {}
