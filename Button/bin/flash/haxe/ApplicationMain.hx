...
class ApplicationMain {
	...
	private static function begin () {
		...
		for (methodName in Type.getClassFields(cl.async.test.Button))
		{
			if (methodName == "main")
			{
				hasMain = true;
		...
		{
			nme.Lib.current.addChild(cast (Type.createInstance(cl.async.test.Button, []), nme.display.DisplayObject));	
		}
